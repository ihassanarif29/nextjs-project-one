    ...
    <div className="h-auto md:h-160 w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0">
      ...
      <div className="p-4 relative z-10 w-full text-center">
        ...
        <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">
          Master modern development skills with hands-on courses designed for
          beginners and professionals alike. Learn programming, web development,
          mobile apps, game development, cloud computing, AI, and more through
